...
- Sends Shift+Enter as a modified Enter key sequence for multiline prompts in compatible shells and CLI tools.
...
- Use **Shift + Enter** for multiline prompts in compatible tools such as Claude Code, Codex, and PowerShell PSReadLine.
