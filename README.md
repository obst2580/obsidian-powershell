...
- Sends Shift+Enter as a line feed for multiline prompts in compatible shells and CLI tools.
...
- Use **Shift + Enter** for multiline prompts in compatible tools such as Claude Code and Codex.
